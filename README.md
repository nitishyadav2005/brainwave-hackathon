...
ABTalks is a 60-day coding challenge platform built for college students to develop coding consistency, build real projects, maintain a public learning streak, and create visible proof of their work.
...
**[Visit ABTalks →](https://brainwave-hackathon.vercel.app/)**
...
- Streak milestones
- Streak Saver system
- Limited Streak Savers to protect a user's progress

### 🔗 Proof of Work

ABTalks focuses on **real proof of work**, not just task completion.
...
ABTalks is designed to work across:
...
ABTalks uses a clean, modern, student-focused interface with:
