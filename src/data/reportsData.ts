...
export const REPORT_LIST: ReportDef[] = [
  ...
  },
  {
    ...
    subtitle: 'CodeTrack Final Project Report — 60-Day Coding Challenge',
...
export const MOCK_CHALLENGE_DAYS: Record<number, ChallengeDayItem> = {
  1: {
    day: 1,
    title: 'Welcome to CodeTrack & First Commit',
    description: 'Set up local development workspace, create initial GitHub repository, and push working code.',
    githubUrl: 'https://github.com/nitish/codetrack-day01',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day01',
  ...
  2: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day02',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day02',
  ...
  3: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day03',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day03',
  ...
  4: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day04',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day04',
  ...
  5: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day05',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day05',
  ...
  6: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day06',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day06',
  ...
  7: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day07',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day07',
  ...
  8: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day08',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day08',
  ...
  9: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day09',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day09',
  ...
  10: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day10',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day10',
  ...
  11: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day11',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day11',
  ...
  12: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day12',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day12',
  ...
  13: {
    ...
    githubUrl: 'https://github.com/nitish/codetrack-day13',
    linkedinUrl: 'https://linkedin.com/posts/nitish-codetrack-day13',
  ...
  for (let i = startDay; i <= endDay; i++) {
    if (MOCK_CHALLENGE_DAYS[i]) {
      ...
      items.push({
        ...
        githubUrl: `https://github.com/nitish/codetrack-day${i}`,
        linkedinUrl: `https://linkedin.com/posts/nitish-codetrack-day${i}`,
